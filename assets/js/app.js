...
/* harmony import */ var _modules_PickupTabs__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_PickupTabs__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _modules_Counter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/Counter */ "./src/assets/js/modules/Counter/index.js");
/* harmony import */ var _modules_CustomInput__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/CustomInput */ "./src/assets/js/modules/CustomInput/index.js");
/* harmony import */ var _modules_Form__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/Form */ "./src/assets/js/modules/Form/index.js");
/* harmony import */ var _modules_Form__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_modules_Form__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _modules_CalcResult__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/CalcResult */ "./src/assets/js/modules/CalcResult/index.js");
/* harmony import */ var _modules_CalcResult__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_modules_CalcResult__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _modules_CalcSteps__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/CalcSteps */ "./src/assets/js/modules/CalcSteps/index.js");
/* harmony import */ var _modules_CalcSteps__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_modules_CalcSteps__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _modules_Tabs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/Tabs */ "./src/assets/js/modules/Tabs/index.js");
/* harmony import */ var _popperjs_core__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @popperjs/core */ "./node_modules/@popperjs/core/lib/index.js");
...
/***/ "./src/assets/js/modules/CalcResult/index.js":
/*!***************************************************!*\
  !*** ./src/assets/js/modules/CalcResult/index.js ***!
  \***************************************************/
/*! no static exports found */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var $sidebar = document.querySelector('.calc-result');
  if (!$sidebar) return;
  var $details = $sidebar.querySelector('.calc-result__details');
  var $sidebarToggle = document.querySelector('.calc-result__collapse');
...
/***/ "./src/assets/js/modules/CalcSteps/index.js":
/*!**************************************************!*\
  !*** ./src/assets/js/modules/CalcSteps/index.js ***!
  \**************************************************/
/*! no static exports found */
...
document.addEventListener('DOMContentLoaded', function () {
  var currentStep = 0;
  var calcSteps = document.querySelector('.calc-steps');
  var stepPoints = document.querySelectorAll('.calc-steps__item');
  var steps = document.querySelectorAll('[data-step-content]');
...
/***/ "./src/assets/js/modules/Counter/Counter.js":
/*!**************************************************!*\
  !*** ./src/assets/js/modules/Counter/Counter.js ***!
  \**************************************************/
/*! exports provided: default */
...
/***/ "./src/assets/js/modules/Counter/index.js":
/*!************************************************!*\
  !*** ./src/assets/js/modules/Counter/index.js ***!
  \************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Counter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Counter */ "./src/assets/js/modules/Counter/Counter.js");

document.querySelectorAll('[data-counter]').forEach(function (el) {
  new _Counter__WEBPACK_IMPORTED_MODULE_0__["default"](el);
});

/***/ }),

/***/ "./src/assets/js/modules/CustomInput/CustomInput.js":
/*!**********************************************************!*\
  !*** ./src/assets/js/modules/CustomInput/CustomInput.js ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return InputWithUnit; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(InputWithUnit, [{
    ...
    value: function _focus() {
      var len = this.$editField.textContent.length;
...
/***/ "./src/assets/js/modules/CustomInput/index.js":
/*!****************************************************!*\
  !*** ./src/assets/js/modules/CustomInput/index.js ***!
  \****************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _CustomInput__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CustomInput */ "./src/assets/js/modules/CustomInput/CustomInput.js");

document.querySelectorAll('[data-input-width-unit]').forEach(function (el) {
  new _CustomInput__WEBPACK_IMPORTED_MODULE_0__["default"](el);
});

/***/ }),

/***/ "./src/assets/js/modules/Form/index.js":
/*!*********************************************!*\
  !*** ./src/assets/js/modules/Form/index.js ***!
  \*********************************************/
/*! no static exports found */
...
function clearSiblings(content) {
  content.parentNode.querySelectorAll('[data-content]').forEach(function (item) {
...
document.addEventListener('change', function (e) {
  var id = e.target.id;
  if (!id) return;
  content = document.querySelector("[data-content=\"".concat(id, "\"]"));
...
dataSlider.forEach(function (el) {
  ...
  new _SliderComponent_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    settings: {
      ...
      breakpoints: (_breakpoints = {}, _defineProperty(_breakpoints, _utils_utils__WEBPACK_IMPORTED_MODULE_1__["MediaQuery"].SM, {
        slidesPerView: 2,
        spaceBetween: 15
      }), _defineProperty(_breakpoints, _utils_utils__WEBPACK_IMPORTED_MODULE_1__["MediaQuery"].MD, {
        slidesPerView: 3,
        spaceBetween: 15
      }), _defineProperty(_breakpoints, _utils_utils__WEBPACK_IMPORTED_MODULE_1__["MediaQuery"].LG, {
        slidesPerView: 4,
        spaceBetween: 30
      }), _breakpoints)
    }
...
/***/ "./src/assets/js/modules/Tabs/index.js":
/*!*********************************************!*\
  !*** ./src/assets/js/modules/Tabs/index.js ***!
  \*********************************************/
/*! no exports provided */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (tabSelectors.length) {
    ...
    try {
      for (var _iterator = _toConsumableArray(tabSelectors).entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var _step$value = _slicedToArray(_step.value, 2),
            i = _step$value[0],
            tabs = _step$value[1];

        tabs.setAttribute("data-tabs-".concat(i), '');
        new tabbyjs__WEBPACK_IMPORTED_MODULE_0___default.a("[data-tabs-".concat(i, "]"));
      }
    } catch (err) {
